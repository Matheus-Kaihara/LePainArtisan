...
2 - Dentro do Xampp clicar no ADMIN do Apache. Vai abrr o endereço de site "localhost" no navegador padrão. Siga o caminho: 📁Padaria >> 📁pages/ >> Site do sistema irá abrir.
